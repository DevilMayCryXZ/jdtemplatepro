	...
	<view class="content">
		...
		<view class="list" v-if="type">
			...
			<view class="list-call">
				...
				<input class="sl-input" v-model="password" type="text" maxlength="20" placeholder="请输入密码" password="true" />
			</view>
		</view>
		<view class="list" v-if="!type">
			<view class="list-call">
			...
			<view class="list-call">
				<input class="sl-input" v-model="phoneYzm" type="text" maxlength="32" placeholder="请输入验证码" password="true" />
